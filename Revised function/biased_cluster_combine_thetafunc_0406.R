## 20220408 new bootstrap dinominater
## 20220406 dealing with Fat-tailed pb(max lowerb, min upperb)
...
dir_path2=paste("/home/whsiang/NA/rdata",sep="") #data output
...
parameters$n=c(50,50)
#nrep_sub<- 10 #for testing
parameters$aa<- c(0.25, 0.4)
parameters$bb<- c(0.22, 0.4)
...
#b = 1 #for test
    ...
    #CBrej
    AD8[d] = (sum(((std_simpleCB_ubs>=0)*(std_simpleCB_lbs<=0))==0)>1) #that * event is accept; accept=0 is reject; sum rej>1 is at least rej at one t
