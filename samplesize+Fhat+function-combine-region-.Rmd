---
title: "samplesize+Fhat+function(combine region)"
author: "David"
date: "2021/12/8"
...
r = c(0.5,1)
nboot = 1000
filename = list.files(path="data/match condition data")
print(filename)
yearlist = list.files(path=paste0("data/match condition data/",filename))
year = strsplit(yearlist,".csv")
out <- function(a){
  for(i in year){
    i = as.integer(i)
    filepath = paste0("data/match condition data/",
